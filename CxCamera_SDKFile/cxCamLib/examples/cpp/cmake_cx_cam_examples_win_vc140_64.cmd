...
cmake %CMAKE_GENERATOR% -DCX_SDK_ROOT:PATH="%CX_SDK_ROOT_64%" -DCMAKE_PREFIX_PATH="%CX_SDK_ROOT_64%/cxBaseLib/lib/;%CX_SDK_ROOT_64%/cxCamLib/lib/;%THIRDPARTY_DIR%/opencv-3.4.2/build_win_vc140_64_shared_vtk_static" ../
